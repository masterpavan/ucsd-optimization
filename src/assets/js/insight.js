(function () {
    ...
    TagSettings = function () {
        function d(a) {
            ...
            this.data.page_url = this.context.win.location.href;
            this.data.hostname = this.context.win.location.hostname;
            this.data.referrer = this.context.doc.referrer;
            this.data.loaded_in_iframe = window.self !== this.context.win.top ? true : false
        }

        d.prefixes = ["_bizo_", "_linkedin_"];
        d.options = {
            partner_id: "data_partner_id",
    ...
    ParamBuilder = function () {
        ...
        d.prototype.add_default_parameters = function () {
            var a, b, c, e;
            a = this.tag_settings.data;
            a = {
                pid: a.partner_id,
                url: a.page_url,
                pageUrl: a.page_url,
                ref: a.referrer,
                fmt: a.use_iframe ? "iframe" : "js"
            };
            e = [];
            for (b in a) {
                c = a[b];
        ...
        d.prototype.add_raw_data_if_present = function () {
            ...
            if (this.tag_settings.data.raw_data_overwrite) return this.params.rdo = "t"
        };
        d.prototype.add_callback_if_present =
            function () {
                if (this.tag_settings.data.use_callback != null) return this.add("callback", "_bizo_callback")
            };
        d.prototype.add_secure_param_if_page_is_secure = function () {
            if (this.tag_settings.data.protocol === "https:") return this.params.s = "1"
        };
    ...
    dom_ready = function () {
        ...
        return function (a) {
            ...
            if (document.addEventListener) {
                ...
                if ((typeof document !==
                    "undefined" && document !== null ? (e = document.documentElement) != null ? e.doScroll : void 0 : void 0) && (typeof window !== "undefined" && window !== null ? window.frameElement : void 0) === null) return b()
            }
        }
    }();
    var PartnerTags;
    PartnerTags = function () {
        ...
        d.fire_partner_pixel = function (a, b, c, e) {
            ...
            return b.write_pixel({
                src: a, onload: function () {
                }
            })
        };
        d.fire_partner_script = function (a,
                                          b, c, e) {
            a.pid.toString();
            a = a.u;
            e.now().getTime();
    ...
    var BaseLogger, ConsoleLogger, ErrorLog, LocalLogger, PixelLogger, __slice = [].slice,
        __hasProp = {}.hasOwnProperty, __extends = function (d, a) {
            function b() {
                this.constructor = d
            }
    ...
    ConsoleLogger = function (d) {
        ...
        a.log = function (b, c) {
            ...
            if (typeof console !== "undefined" && console !== null && console.log != null) return console.log(e)
        };
        return a
    }(BaseLogger);
    ...
    DOMUtil = function () {
        ...
        d.prototype.write_iframe = function (a,
                                             b) {
            if (a == null) a = {};
            if (b == null) b = this.body;
    ...
    Tag = function () {
        ...
        d.defaults = function (a) {
            switch (a) {
                ...
                case "img":
                    return {width: "1", height: "1", border: "0", alt: "", style: {display: "none"}};
                case "iframe":
                    return {width: 0, height: 0, marginWidth: 0, marginHeight: 0, frameBorder: 0, scrolling: "no"};
                default:
                    return {}
            }
        };
        d.prototype.to_html_string = function () {
            ...
            for (a in f) {
                e = f[a];
                b = a.toLowerCase();
                if (!this._is_object(e) && a !== "innerHTML" && a !== "text") c += " " + b + "='" + e + "'";
                if (a === "style") c += " " + b + "='" + this._get_style_string(e) + "'"
            }
            c += ">";
            if (this.attributes.text != null) c += "" + this.attributes.text;
            if (this.attributes.innerHTML != null) c += "" + this.attributes.innerHTML;
            c += "</" + this.type + ">";
            return c
        };
        ...
        d.prototype._set_multiple_properties =
            function (a, b, c) {
                var e, f, g;
                g = [];
                for (e in c) {
    ...
    QueryStringBuilder = function () {
        ...
        d.build = function (a) {
            ...
            for (b in a) {
                g = a[b];
                if (g != null) if (ArrayUtil.is_array(g)) {
                    e = function () {
                        var h, i, j;
                        j = [];
                        h = 0;
    ...
    CookieManager = function () {
        ...
        d.prototype.set = function (a, b, c, e) {
            if (c == null) c = 1;
            if (e == null) e = "/";
            c = "expires=" + this.context.clock.future_date(this.one_day * c).toGMTString();
            return this.context.doc.cookie = "" + a + "=" + escape(b) + "; " + c + "; path=" + e
        };
    ...
    Clock = function () {
        ...
        d.prototype._timewarp = function (a) {
            return this._create_date(this.now().getTime() +
                a)
        };
    ...
    InsightTags = function () {
        ...
        d.prototype.create_query_string = function () {
            var a;
            a = (new ParamBuilder(this.tag_settings)).build();
            return QueryStringBuilder.build(a)
        };
        d.prototype.write_tags_to_dom = function () {
            ...
            if (this.tag_settings.data.use_iframe != null) this.dom.write_iframe({id: "_bizo_iframe", src: a}); else {
                if (this.tag_settings.data.async_target !=
                    null) b = this.context.doc.getElementById(this.tag_settings.data.async_target);
            ...
            return a._bizo_fire_partners = function (b) {
                return function (c) {
                    try {
                        ...
                        return ErrorLog.log(b.context, {error: e}, PixelLogger, ConsoleLogger, LocalLogger)
                    }
                }
            }(this)
        };
        d.prototype.init = function () {
            var a, b, c, e, f;
            f = this.exit_conditions = [["no partner id", this.tag_settings.data.partner_id == null]];
            c = 0;
    ...
    dom_ready(function () {
        ...
        try {
            ...
            return ErrorLog.log(d, {
                error: a,
                pid: window._bizo_data_partner_id
